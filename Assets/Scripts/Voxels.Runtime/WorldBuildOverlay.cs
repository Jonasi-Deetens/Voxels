...
{
    public sealed class WorldBuildOverlay : MonoBehaviour
    {
        ...
        public static WorldBuildOverlay Ensure()
        {
            WorldBuildOverlay existing = FindAnyObjectByType<WorldBuildOverlay>();
            if (existing != null)
            {
                return existing;
            }

            var root = new GameObject("WorldBuildOverlay");
            ...
            var overlay = root.AddComponent<WorldBuildOverlay>();
